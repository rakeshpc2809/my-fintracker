...
## Codebase Intelligence for my-fintracker (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-30 (commit 6f5e209). Confidence: 100%.
...
### Architecture
**Files:** 89 | **Lines:** 10779 | **Import cycles:** 1
my-fintracker is a kotlin codebase of 89 files. Execution starts at parsers/app.py, tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api/Application.kt, web-cockpit/src/app.js. Start here when reading the codebase. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on.

### Key modules
- `tax-domain` — tax-domain · tax-domain/tax-adapter-api · tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api ·…
- `tax-domain/tax-core` — tax-domain/tax-core · tax-domain/tax-core/src/main/kotlin/com/fintracker/tax/core/insurance ·…
- `mobile-app/android/app/src/main/assets/public/_app/immutable/chunks` — mobile-app/android/app/src/main/assets/public/_app/immutable/chunks ·…
- `parsers` — parsers · parsers/src/fintracker_parsers · tax-domain
**Language:** python | **Files:** 9 | **Public symbols:** 17 / 17
Covers the 9 source…
- `valuation-engine` — valuation-engine · valuation-engine/src/main/kotlin/com/fintracker/valuation/advisor ·…
- `mobile-app/android/app/src/main/java/com/fintracker/portfolioos` — mobile-app/android/app/src/main/java/com/fintracker/portfolioos · mobile-app/android/app/src/main/java/com/fintracker/portfolioos/ui ·…
- `tax-domain/tax-adapter-api` — tax-domain/tax-adapter-api · tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api ·…
- `mobile-app/android/app/src/main/assets/public` — mobile-app/android/app/src/main/assets/public · mobile-app/android/app/src/main/assets/public/_app/immutable/nodes
**Language:** javascript…

### Entry points
- `parsers/app.py`
- `web-cockpit/src/app.js`
- `tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api/Application.kt`

### Files that need care (bug-fix history first, then churn — check `get_risk` before editing)
- `valuation-engine/src/main/kotlin/com/fintracker/valuation/xirr/XirrEngine.kt` — 1 bug fix, last fix 4 days ago; 3 commits/90d
- `web-cockpit/src/app.js` — 5 commits/90d
- `tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api/routes/ReportRoutes.kt` — 6 commits/90d

### Code health
Three co-equal signals: defect risk 7.46/10 avg, hotspot health 3.97/10 (stable), worst `web-cockpit/src/app.js` at 2.76/10 · maintainability 8.4/10 · performance risk 6 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `tax-domain/tax-adapter-api/src/main/kotlin/com/fintracker/tax/api/routes/ReportRoutes.kt` — large method (reportRoutes) — impact −0.9
- `valuation-engine/src/main/kotlin/com/fintracker/valuation/advisor/BucketEngine.kt` — brain method (evaluateRebalance) — impact −0.7
